...
def process_log_file(cur, filepath):
    ...
    time_data_dict = {'timestamp': time_data[0],
                  'hour': time_data[1],
                  'day': time_data[2],
                  'weekofyear': time_data[3],
                  'month': time_data[4],
                  'year': time_data[5],
                  'weekday': time_data[6],
                 }
...
def process_data(cur, conn, filepath, func):
    """
    Description: This function invokes the function passed in the input argument - "func" for each file in the data path - "filepath".
...
def main():
    ...
    Description: This is the main function where the processing starts when this python script runs.
                 It connects to the sparkifydb and creates a connection to it. It calls the process_data
                 function passing this cursor, connection, data file path and the function to invoke.
